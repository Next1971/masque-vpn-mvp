...
- v1.4.2: experimental Windows VPS Setup Helper (superseded for revoke by v1.5.1 `masque-setup.exe`)
  ...
  What is next lives in the [roadmap](docs/ROADMAP.md) (**v1.5.4** dual-port/DoH and numbered `*.masque` files, **v1.7** TestFlight not later than **12 October 2026**, **v1.8** phone QR import).
